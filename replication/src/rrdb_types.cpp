...
read_response::read_response( read_response&& other5) {
  error = std::move(other5.error);
  value = std::move(other5.value);
  __isset = std::move(other5.__isset);
}
read_response& read_response::operator=(const read_response& other6) {
  error = other6.error;
  value = other6.value;
  __isset = other6.__isset;
  return *this;
}
read_response& read_response::operator=(read_response&& other7) {
